-- Prevent API accessing the schema
...
on storage.objects for insert to authenticated with check (
  bucket_id = 'files' and
    owner = auth.uid() and
    -- Use RSL policy for extra security
    -- postgres arrays start with 1, not 0
    -- ensure the autogenerated id is not null to avoid malicious behavior
